<script lang="ts">
    ...
    onMount(async () => {
        data = await fetch("https://ferrets.leodog896.com/v1/data/random").then(response => response.json());
        ...
        <div class="displayBlock">
            ...
            <div class="code left-margin">
                ...
                <p>
                    ...
                    <br />
                    <span class="description">returns the JSON object of a ferret.json file for some UUID.</span>
                </p>
            </div>
        </div>
